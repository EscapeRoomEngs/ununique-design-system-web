export const typography = {
  ...
  usage: {
    ...
    body: {
      styles: {
        p1: { style: "Large", webSize: 19, mobileSize: 17 },
        p2: { style: "Medium", webSize: 17, mobileSize: 15 },
        p3: { style: "Small", webSize: 15, mobileSize: 13 },
    ...
    lable: {
      styles: {
        lable1: { style: "Large", webSize: 19, mobileSize: 17 },
        lable2: { style: "Medium", webSize: 17, mobileSize: 15 },
        lable3: { style: "Small", webSize: 15, mobileSize: 13 },
      },
      weight: 600,
      lineHeight: "130%",
      letterSpacing: "0%",
