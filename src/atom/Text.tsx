...
export type FontColor = "primary" | "secondary" | "tertiary" | "invert" | "brand" | "negative" | "positive" | "info";
...
const colors: Record<FontColor, string> = { primary: "text-uui-text-primary", secondary: "text-uui-text-secondary", tertiary: "text-uui-text-tertiary", invert: "text-uui-text-invert", brand: "text-uui-text-brand", negative: "text-uui-text-negative", positive: "text-uui-text-positive", info: "text-uui-text-info" };
