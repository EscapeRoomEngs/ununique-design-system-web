...
const buttonVariants = cva(
  "inline-flex cursor-pointer items-center justify-center gap-2 font-semibold transition-colors motion-reduce:transition-none focus-visible:outline-solid focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-uui-focus-brand disabled:pointer-events-none disabled:cursor-not-allowed disabled:bg-uui-surface-tertiary disabled:text-uui-text-tertiary",
  {
    variants: {
      ...
      property: {
        outlined: "border border-uui-border-default bg-uui-surface-primary text-uui-text-secondary hover:border-uui-border-hover hover:bg-uui-surface-secondary active:border-uui-border-tertiary active:bg-uui-surface-tertiary",
        brand: "bg-uui-surface-brand text-uui-text-invert hover:bg-uui-surface-brand-hover active:bg-uui-surface-brand-active",
        negative: "bg-uui-surface-negative text-uui-text-negative hover:bg-uui-surface-negative-hover active:bg-uui-surface-negative-active",
        positive: "bg-uui-surface-positive text-uui-text-positive hover:bg-uui-surface-positive-hover active:bg-uui-surface-positive-active",
        info: "bg-uui-surface-info text-uui-text-info hover:bg-uui-surface-info-hover active:bg-uui-surface-info-active",
        invert: "bg-uui-surface-invert text-uui-text-invert hover:bg-uui-surface-invert-hover active:bg-uui-surface-invert-active",
      },
    },
